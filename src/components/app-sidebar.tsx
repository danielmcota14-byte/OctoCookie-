...
import { PanelLeft, SquarePen, Rocket, Settings as SettingsIcon, Trash2, TerminalSquare, Code2, LineChart, LayoutDashboard, Wallet } from "lucide-react";
    ...
    >
      <div className="flex items-center gap-2 p-3">
        <button
          ...
          className="grid h-9 w-9 shrink-0 place-items-center rounded-md hover:bg-sidebar-accent"
